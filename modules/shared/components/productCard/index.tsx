...
const ProductCard: React.FC<Props> = ({ title, imagen, price }) => {
  return (
    <div className={`text-center group ease-in duration-300`}>
      <div className="h-52 md:h-64 lg:h-96 rounded-2xl cursor-pointer overflow-hidden relative 	w-full hover:before:absolute hover:before:inset-0 hover:before:bg-dark hover:before:opacity-10">
